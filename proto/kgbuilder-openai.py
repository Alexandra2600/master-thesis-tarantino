import os
from proto.util.neo4jconnector import Neo4jConnection
from proto.util.utils import getNLOntology
...
with open('content/day4.txt', 'r') as file:
   content = file.read().replace('\n', '')


####### STEP2: GET THE ONTOLOGY #####################################
g = Graph()
g.parse("ontologies/diary.ttl")
...
uri = "neo4j+s://9fca2e1c.databases.neo4j.io"
user = "neo4j"  # Change if you've modified the default username
password = "fk6B9CmFqUv-HWxRA7CsO8hIhs8OskCESdGM0mNx2x4"  # Change to your actual password
